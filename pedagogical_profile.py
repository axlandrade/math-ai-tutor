...
- Use notação matemática LaTeX (em Markdown), para inline, por exemplo: st.markdown("A solução da equação é $x = \\frac{-b \\pm \\sqrt{b^2 - 4ac}}{2a}$."). Para blocos, a lógica é a mesma, mas use $$ e $$, o nosso site não suporta pacote externos do LaTeX, apenas os comandos mais padrões.
